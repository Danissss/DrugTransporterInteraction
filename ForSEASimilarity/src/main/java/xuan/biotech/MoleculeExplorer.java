...
//		System.out.println("After preprocessing\n" + w2.toString() + "\n\n");
	...
	public static boolean isEtherLipid(IAtomContainer molecule) throws Exception{	
		...
		Pattern ptrn = SmartsPattern.create(constraints);
...
//		b = pattern.hasSMARTSPattern(molecule)>0;
	...
	public static boolean isGlyceroLipid(IAtomContainer molecule) throws Exception{	
...
//		b = pattern.hasSMARTSPattern(molecule)>0;
	...
	public static boolean isGlycerophosphoLipid(IAtomContainer molecule) throws Exception{	
...
//		b = pattern.hasSMARTSPattern(molecule)>0;
	...
	public static boolean isSphingoLipid(IAtomContainer molecule) throws Exception{	
	...
	public boolean isInvalidCandidate(IAtomContainer molecule) throws Exception{
